...
class RecommendedModel(str, Enum):
    ...
    # Claude 모델들 (Sonnet 4.5, 3.5 v2만 ARN 필요)
    ...
    CLAUDE_3_5_SONNET_V2 = "arn:aws:bedrock:us-east-1:261595668962:inference-profile/us.anthropic.claude-3-5-sonnet-20241022-v2:0"
