...
class VarianceStage:
    ...
    def _get_model_short_name(self, model_id: str) -> str:
        ...
        short_names = {
            ...
            "arn:aws:bedrock:us-east-1:261595668962:inference-profile/us.anthropic.claude-3-5-sonnet-20241022-v2:0": "Claude 3.5 v2",
